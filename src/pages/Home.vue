<template>
  <div id="home">
      ...
      <div class="col-md-8 content">
        <div class="row items-center justify-center">
          <div class="input-area-1 col-md-5 col-xs-12" style="background-color: white; border-radius: 29px 0 0 29px">
            <q-select bg-color="white" rounded outlined v-model="where_to" :options="options" label="Where to?"
          ...
          <div class="input-area-1 col-md-4 col-xs-12" style="background-color: white; border-radius: 0px">
            <q-select bg-color="white" rounded outlined v-model="category" :options="options_category" label="Category?"
              style="font-family: Poppins;">
              <template v-slot:prepend>
          ...
          <div class="input-area-4 col-md-3 col-xs-12" style="border-radius: 0 29px 29px 0; font-family: Poppins">
            <q-btn rounded standout flat color="" text-color="white" class="search-btn" icon="search" label="Search"
              @click="go_to_category_itinerary(this.where_to, this.category)" style="font-size: 17px" />
          </div>
        </div>
      </div>
          ...
          <transition name="pop" appear>
            <div class="modal" role="dialog" v-if="showModal" style="max-width: fit-content">
              <div class="chatgpt-prompt">
                ...
                <q-input v-model="area" class="text-area" type="textarea" float-label="Textarea" :max-height="100"
                  :min-rows="3" placeholder="I want to go to Himachal Pradesh for 5 days with my family." />
              </div>
              <button @click="create_chatgpt_prompt()" class="button submit-btn">
                Submit
              </button>
            </div>
          </transition>
    ...
    <div class="main-container-mobile row justify-center q-pa-md lt-md">
      <div class="col-md-8 content">
        <div class="row items-center justify-center">
          <div class="input-area-1 col-md-3 col-xs-12" style="background-color: white; border-radius: 14px 14px 0 0">
          ...
          <div class="input-area-2 col-md-3 col-xs-12" style="background-color: white">
            <q-select bg-color="white" filled v-model="category" :options="options_category" label="Category"
              style="font-family: Poppins">
              <template v-slot:prepend>
          ...
          <div class="input-area-4 col-md-3 col-xs-12" style="border-radius: 0 0 14px 14px">
            <q-btn style="font-family: Poppins" color="" class="search-btn" icon="search" label="Search"
    ...
    <div class="q-pa-sm" style="margin-top: 50px;" id="destinations">
      ...
      <Carousel :itemsToShow="isMobile ? 1.3 : 6" v-model="slide">
        <Slide v-for="(items) in top_selling_itineraries" :key="items" arrows>
          <div class="carousel__item-1" style="margin-top: 0px" @click="this.view_itinerary(items.pk)">
            <q-card class="destination-carousel-card itineraries-free-badge" style="cursor: pointer">
              <img :src="items.fields.place_img" />
              <q-card-section>
                <div class="row no-wrap justify-between">
                  <div class="col-md-10 text-black text-caption text-weight-fat bold"
    ...
    <div class="q-pa-sm" style="margin-top: 50px" id="destinations">
      ...
      <Carousel :itemsToShow="isMobile ? 1.3 : 6" v-model="slide">
        <Slide v-for="(items, index) in basic_data['explore_destination_images']" :key="items" arrows>
          <div class="carousel__item-1" style="margin-top: 0px"
            @click="go_to_images(basic_data['explore_destination'][index])">
            ...
            <q-list v-for="(items, index) in basic_data['headers_of_why_choose_us']" :key="items">
              <q-item v-ripple style="cursor: pointer;">
                <q-item-section avatar>
                  <q-avatar rounded :color="svgs_color[index]" text-color="white">
    ...
    <div class="q-pa-xs carousel-main" id="testimonials">
      ...
      <Carousel :itemsToShow="isMobile ? 1 : 2.2" :itemsToScroll="1" :wrap-around="true" v-bind:autoplay="5000"
        v-bind:pause-autoplay-on-hover="true" style="margin-top: -30px">
    ...
    <div id="blogs">
      ...
      <div class="q-pa-md blogs-carousel">
        <Carousel v-model="currentIndex" :itemsToShow="isMobile ? 1.3 : 4.3">
          <Slide v-for="(item, index) in carouselItems" :key="index" style="margin-bottom: 30px" class="blogs-card">
              ...
              <span>
                ...
                <nav class="col-list">
                  <ul>
                    ...
                    <li>
                      <h3 class="social-col-title" style="
                          margin-top: 30px;
                          font-family: Poppins;
                          font-size: 19px;
                        ">
                      ...
                      <div class="social-media-list">
                        <a href="https://instagram.com/travel_rovers?igshid=MzRlODBiNWFlZA==" class="instagram"><svg
